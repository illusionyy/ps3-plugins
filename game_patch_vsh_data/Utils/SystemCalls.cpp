...
{
    CellFsStat sb;
    if (cellFsStat("/dev_hdd0/plugins/webftp_server.sprx", &sb) == CELL_FS_SUCCEEDED || cellFsStat("/dev_hdd0/plugins/webftp_server_noncobra.sprx", &sb) == CELL_FS_SUCCEEDED || cellFsStat("/dev_hdd0/plugins/webftp_server_cobra_ps3mapi.sprx", &sb) == CELL_FS_SUCCEEDED)
    {
        return true;
    }
